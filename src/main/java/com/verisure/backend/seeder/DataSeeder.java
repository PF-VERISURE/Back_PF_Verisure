...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedProjects() {
        ...
        new ProjectTemplate("Campaña de Restauración de Juguetes", "Durante las semanas previas a la Navidad, necesitamos personas con habilidades manuales para reparar y restaurar juguetes donados. Tu ayuda permitirá que muchos niños reciban un regalo en estas fechas tan especiales.", "Juguetes preparados", "https://images.unsplash.com/photo-1560856218-0da41ac1c6ea?w=800&q=80", List.of(12, 10)),
